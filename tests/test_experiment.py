...
def test_stub_not_implemented_does_not_count_as_attempt(tmp_path, monkeypatch):
...
def test_library_not_implemented_counts_as_failure(tmp_path, monkeypatch):
...
def test_completed_run_records_full_config(tmp_path, monkeypatch):
